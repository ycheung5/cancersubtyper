...
def run_bctypefinder(
    ...
    parameters = normalize_model_parameters("BCtypeFinder", model_parameters)
    is_using_pretrained_model = parameters["is_using_pretrained_model"]
    pretrained_ckpt_path = ASSET_DIR / "bctypefinder_full_pretrained.pt"
    ...
    def get_embed_domain(domain_dataloader, fe_model, c_model):
        ...
        pred_prob_list = torch.cat(pred_prob_list, 0)
        return X_embed_list, domain_list, pred_subtype_list, label_list, pred_prob_list
    ...
    data_X_embed, domain_label, pred_subtype, label_subtype, pred_prob = get_embed_domain(domain_dataloader, feature_extract_model,
                                                                               subtype_pred_model)
    ...
    subtype_info_df = subtype_info.copy() #ADD
