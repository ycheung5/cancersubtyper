                    ...
                    <div className="space-y-8">
                        <div className="breadcrumbs text-md">
                            <ul>
                                ...
                                <li className="text-base-content">Demo Project</li>
                            </ul>
                        </div>

                        <div className="space-y-8">
                            <div className="flex justify-between items-center">
                                <h1 className="text-3xl font-bold text-base-content truncate max-w-[70%]">Demo Project</h1>
                                ...
                                <div className="p-6 bg-base-100 rounded-lg shadow-md border border-base-300">
                                    ...
                                    <div className="flex justify-end gap-3 mt-5">
                                        ...
                                        <button
                                            ...
                                            onClick={() => navigate(RouteConstants.visualizationExamples)}
                                        >
